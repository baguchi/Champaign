...
public class ChampaignModelData extends ModelProvider {
    private final PackOutput.PathProvider blockStatePathProvider;
    private final PackOutput.PathProvider itemInfoPathProvider;
    private final PackOutput.PathProvider modelPathProvider;

    public ChampaignModelData(PackOutput packOutput) {
        super(packOutput, Champaign.MODID);
    ...
    public CompletableFuture<?> run(CachedOutput output) {
        ...
        this.registerModels(new ModBlockModels(blockModelOutput, itemModelOutput, modelOutput), new ModItemModels(itemModelOutput, modelOutput));
